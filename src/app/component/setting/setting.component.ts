...
export class SettingComponent implements OnInit {
  @ViewChild('name', { read: ElementRef, static:false }) name: ElementRef | any;
  @ViewChild('pass', { read: ElementRef, static:false }) pass: ElementRef | any;
  @ViewChild('cPass', { read: ElementRef, static:false }) cPass: ElementRef | any;
  @ViewChild('status', { read: ElementRef, static:false }) status: ElementRef | any;
...
getUserData(){
  this.ShareFunctionsServic.getUserData().subscribe((data:any)=>{
    this.userData =data
  });
}
}
